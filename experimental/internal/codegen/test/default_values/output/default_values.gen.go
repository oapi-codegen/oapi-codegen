...
type NestedDefaultsSchemaComponent struct {
	...
	Child       *SimpleDefaults            `json:"child,omitempty"`
	InlineChild *NestedDefaultsInlineChild `json:"inlineChild,omitempty"`
}
...
type AnyOfWithDefaultsSchemaComponent struct {
	Value *AnyOfWithDefaultsValue `json:"value,omitempty"`
}
...
type OneOfWithDefaultsSchemaComponent struct {
	Variant *OneOfWithDefaultsVariant `json:"variant,omitempty"`
}
...
type DeepNestingSchemaComponent struct {
	Level1 *DeepNestingLevel1 `json:"level1,omitempty"`
}
...
type DeepNestingLevel1PropertySchemaComponent struct {
	Name   *string                  `json:"name,omitempty"`
	Level2 *DeepNestingLevel1Level2 `json:"level2,omitempty"`
}
...
type DeepNestingLevel1Level2PropertyPropertySchemaComponent struct {
	Count  *int                           `json:"count,omitempty"`
	Level3 *DeepNestingLevel1Level2Level3 `json:"level3,omitempty"`
}
...
type RequiredAndOptionalSchemaComponent struct {
	RequiredWithDefault string  `json:"requiredWithDefault"`
	RequiredNoDefault   string  `json:"requiredNoDefault"`
	OptionalWithDefault *string `json:"optionalWithDefault,omitempty"`
	OptionalNoDefault   *string `json:"optionalNoDefault,omitempty"`
}
