...
func main() {
	...
	flag.StringVar(&flagGenerate, "generate", "types,client,server,spec",
		`Comma-separated list of code to generate; valid options: "types", "client", "chi-server", "fiber", "server", "gin", "gorilla", "spec", "skip-fmt", "skip-prune"`)
