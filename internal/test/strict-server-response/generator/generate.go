			...
			for _, header := range []bool{false, true} {
				for _, fixedStatusCode := range []bool{false, true} {
					for _, content := range []struct {
						...
						generateOneTest(fTestGo, paths, responses, ref, extRef, header, fixedStatusCode, content)
					}
				}
			}
		}
...
func generateOneTest(fTestGo io.Writer, paths map[string]any, responses map[int]map[string]any,
