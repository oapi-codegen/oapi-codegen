...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-formdata", wrapper.TestFixedFormdata)
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-json", wrapper.TestFixedJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-multipart", wrapper.TestFixedMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-multipart-related", wrapper.TestFixedMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-nocontent", wrapper.TestFixedNoContent)
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-other", wrapper.TestFixedOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-special-json", wrapper.TestFixedSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-fixed-wildcard", wrapper.TestFixedWildcard)
	m.HandleFunc("GET "+options.BaseURL+"/test-formdata", wrapper.TestFormdata)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-fixed-formdata", wrapper.TestHeaderFixedFormdata)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-fixed-json", wrapper.TestHeaderFixedJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-fixed-multipart", wrapper.TestHeaderFixedMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-fixed-multipart-related", wrapper.TestHeaderFixedMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-fixed-other", wrapper.TestHeaderFixedOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-fixed-special-json", wrapper.TestHeaderFixedSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-fixed-wildcard", wrapper.TestHeaderFixedWildcard)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-formdata", wrapper.TestHeaderFormdata)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-json", wrapper.TestHeaderJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-multipart", wrapper.TestHeaderMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-multipart-related", wrapper.TestHeaderMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-other", wrapper.TestHeaderOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-special-json", wrapper.TestHeaderSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-header-wildcard", wrapper.TestHeaderWildcard)
	m.HandleFunc("GET "+options.BaseURL+"/test-json", wrapper.TestJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-multipart", wrapper.TestMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-multipart-related", wrapper.TestMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-nocontent", wrapper.TestNoContent)
	m.HandleFunc("GET "+options.BaseURL+"/test-other", wrapper.TestOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-fixed-json", wrapper.TestRefFixedJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-fixed-multipart", wrapper.TestRefFixedMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-fixed-multipart-related", wrapper.TestRefFixedMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-fixed-nocontent", wrapper.TestRefFixedNoContent)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-fixed-other", wrapper.TestRefFixedOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-fixed-special-json", wrapper.TestRefFixedSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-fixed-wildcard", wrapper.TestRefFixedWildcard)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-fixed-json", wrapper.TestRefHeaderFixedJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-fixed-multipart", wrapper.TestRefHeaderFixedMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-fixed-multipart-related", wrapper.TestRefHeaderFixedMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-fixed-other", wrapper.TestRefHeaderFixedOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-fixed-special-json", wrapper.TestRefHeaderFixedSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-fixed-wildcard", wrapper.TestRefHeaderFixedWildcard)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-json", wrapper.TestRefHeaderJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-multipart", wrapper.TestRefHeaderMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-multipart-related", wrapper.TestRefHeaderMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-other", wrapper.TestRefHeaderOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-special-json", wrapper.TestRefHeaderSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-header-wildcard", wrapper.TestRefHeaderWildcard)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-json", wrapper.TestRefJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-multipart", wrapper.TestRefMultipart)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-multipart-related", wrapper.TestRefMultipartRelated)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-nocontent", wrapper.TestRefNoContent)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-other", wrapper.TestRefOther)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-special-json", wrapper.TestRefSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-ref-wildcard", wrapper.TestRefWildcard)
	m.HandleFunc("GET "+options.BaseURL+"/test-special-json", wrapper.TestSpecialJSON)
	m.HandleFunc("GET "+options.BaseURL+"/test-wildcard", wrapper.TestWildcard)
