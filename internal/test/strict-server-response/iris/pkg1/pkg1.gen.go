...
type ServerInterface interface {
	...
	TestExtFixedMultipart(ctx iris.Context)

	// (GET /test-ext-fixed-multipart-related)
	TestExtFixedMultipartRelated(ctx iris.Context)

	// (GET /test-ext-fixed-nocontent)
	TestExtFixedNoContent(ctx iris.Context)

	// (GET /test-ext-fixed-other)
	TestExtFixedOther(ctx iris.Context)

	// (GET /test-ext-fixed-special-json)
	TestExtFixedSpecialJSON(ctx iris.Context)

	// (GET /test-ext-fixed-wildcard)
	TestExtFixedWildcard(ctx iris.Context)

	// (GET /test-ext-header-fixed-json)
	TestExtHeaderFixedJSON(ctx iris.Context)

	// (GET /test-ext-header-fixed-multipart)
	TestExtHeaderFixedMultipart(ctx iris.Context)

	// (GET /test-ext-header-fixed-multipart-related)
	TestExtHeaderFixedMultipartRelated(ctx iris.Context)

	// (GET /test-ext-header-fixed-nocontent)
	TestExtHeaderFixedNoContent(ctx iris.Context)

	// (GET /test-ext-header-fixed-other)
	TestExtHeaderFixedOther(ctx iris.Context)

	// (GET /test-ext-header-fixed-special-json)
	TestExtHeaderFixedSpecialJSON(ctx iris.Context)

	// (GET /test-ext-header-fixed-wildcard)
	TestExtHeaderFixedWildcard(ctx iris.Context)

	// (GET /test-ext-header-multipart)
	TestExtHeaderMultipart(ctx iris.Context)

	// (GET /test-ext-header-multipart-related)
	TestExtHeaderMultipartRelated(ctx iris.Context)

	// (GET /test-ext-header-nocontent)
	TestExtHeaderNoContent(ctx iris.Context)

	// (GET /test-ext-header-other)
	TestExtHeaderOther(ctx iris.Context)

	// (GET /test-ext-header-wildcard)
	TestExtHeaderWildcard(ctx iris.Context)

	// (GET /test-ext-multipart)
	TestExtMultipart(ctx iris.Context)

	// (GET /test-ext-multipart-related)
	TestExtMultipartRelated(ctx iris.Context)

	// (GET /test-ext-nocontent)
	TestExtNoContent(ctx iris.Context)

	// (GET /test-ext-other)
	TestExtOther(ctx iris.Context)

	// (GET /test-ext-wildcard)
	TestExtWildcard(ctx iris.Context)
...
// TestExtFixedMultipart converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtFixedMultipart(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtFixedMultipart(ctx)
}

// TestExtFixedMultipartRelated converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtFixedMultipartRelated(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtFixedMultipartRelated(ctx)
}

// TestExtFixedNoContent converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtFixedNoContent(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtFixedNoContent(ctx)
}

// TestExtFixedOther converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtFixedOther(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtFixedOther(ctx)
}

// TestExtFixedSpecialJSON converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtFixedSpecialJSON(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtFixedSpecialJSON(ctx)
}

// TestExtFixedWildcard converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtFixedWildcard(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtFixedWildcard(ctx)
}

// TestExtHeaderFixedJSON converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderFixedJSON(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderFixedJSON(ctx)
}

// TestExtHeaderFixedMultipart converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderFixedMultipart(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderFixedMultipart(ctx)
}

// TestExtHeaderFixedMultipartRelated converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderFixedMultipartRelated(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderFixedMultipartRelated(ctx)
}

// TestExtHeaderFixedNoContent converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderFixedNoContent(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderFixedNoContent(ctx)
}

// TestExtHeaderFixedOther converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderFixedOther(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderFixedOther(ctx)
}

// TestExtHeaderFixedSpecialJSON converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderFixedSpecialJSON(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderFixedSpecialJSON(ctx)
}

// TestExtHeaderFixedWildcard converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderFixedWildcard(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderFixedWildcard(ctx)
}

// TestExtHeaderMultipart converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderMultipart(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderMultipart(ctx)
}

// TestExtHeaderMultipartRelated converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderMultipartRelated(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderMultipartRelated(ctx)
}

// TestExtHeaderNoContent converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderNoContent(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderNoContent(ctx)
}

// TestExtHeaderOther converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderOther(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderOther(ctx)
}

// TestExtHeaderWildcard converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtHeaderWildcard(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtHeaderWildcard(ctx)
}

// TestExtMultipart converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtMultipart(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtMultipart(ctx)
}

// TestExtMultipartRelated converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtMultipartRelated(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtMultipartRelated(ctx)
}

// TestExtNoContent converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtNoContent(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtNoContent(ctx)
}

// TestExtOther converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtOther(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtOther(ctx)
}

// TestExtWildcard converts iris context to params.
func (w *ServerInterfaceWrapper) TestExtWildcard(ctx iris.Context) {

	// Invoke the callback with all the unmarshaled arguments
	w.Handler.TestExtWildcard(ctx)
}
...
type TestExtFixedMultipartResponseObject interface {
	VisitTestExtFixedMultipartResponse(ctx iris.Context) error
}

type TestExtFixedMultipart200MultipartResponse externalRef0.TestRespExtFixedMultipartMultipartResponse

func (response TestExtFixedMultipart200MultipartResponse) VisitTestExtFixedMultipartResponse(ctx iris.Context) error {
...
type TestExtFixedMultipartRelatedResponseObject interface {
	VisitTestExtFixedMultipartRelatedResponse(ctx iris.Context) error
}

type TestExtFixedMultipartRelated200MultipartResponse externalRef0.TestRespExtFixedMultipartRelatedMultipartResponse

func (response TestExtFixedMultipartRelated200MultipartResponse) VisitTestExtFixedMultipartRelatedResponse(ctx iris.Context) error {
	writer := multipart.NewWriter(ctx.ResponseWriter())
...
type TestExtFixedNoContentResponseObject interface {
	VisitTestExtFixedNoContentResponse(ctx iris.Context) error
}

type TestExtFixedNoContent204Response externalRef0.TestRespExtFixedNoContentResponse

func (response TestExtFixedNoContent204Response) VisitTestExtFixedNoContentResponse(ctx iris.Context) error {
	ctx.StatusCode(204)
	return nil
}
...
type TestExtFixedOtherResponseObject interface {
	VisitTestExtFixedOtherResponse(ctx iris.Context) error
}
...
func (response TestExtFixedOther200ApplicationtestResponse) VisitTestExtFixedOtherResponse(ctx iris.Context) error {
...
type TestExtFixedSpecialJSONResponseObject interface {
	VisitTestExtFixedSpecialJSONResponse(ctx iris.Context) error
}
...
func (response TestExtFixedSpecialJSON200ApplicationTestPlusJSONResponse) VisitTestExtFixedSpecialJSONResponse(ctx iris.Context) error {
...
type TestExtFixedWildcardResponseObject interface {
	VisitTestExtFixedWildcardResponse(ctx iris.Context) error
}
...
func (response TestExtFixedWildcard200ApplicationResponse) VisitTestExtFixedWildcardResponse(ctx iris.Context) error {
...
type TestExtHeaderFixedJSONResponseObject interface {
	VisitTestExtHeaderFixedJSONResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderFixedJSON200JSONResponse) VisitTestExtHeaderFixedJSONResponse(ctx iris.Context) error {
...
type TestExtHeaderFixedMultipartResponseObject interface {
	VisitTestExtHeaderFixedMultipartResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderFixedMultipart200MultipartResponse) VisitTestExtHeaderFixedMultipartResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	writer := multipart.NewWriter(ctx.ResponseWriter())
	ctx.ResponseWriter().Header().Set("Content-Type", writer.FormDataContentType())
...
type TestExtHeaderFixedMultipartRelatedResponseObject interface {
	VisitTestExtHeaderFixedMultipartRelatedResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderFixedMultipartRelated200MultipartResponse) VisitTestExtHeaderFixedMultipartRelatedResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	writer := multipart.NewWriter(ctx.ResponseWriter())
	ctx.ResponseWriter().Header().Set("Content-Type", mime.FormatMediaType("multipart/related", map[string]string{"boundary": writer.Boundary()}))
...
type TestExtHeaderFixedNoContentResponseObject interface {
	VisitTestExtHeaderFixedNoContentResponse(ctx iris.Context) error
}

type TestExtHeaderFixedNoContent204Response externalRef0.TestRespExtHeaderFixedNoContentResponse

func (response TestExtHeaderFixedNoContent204Response) VisitTestExtHeaderFixedNoContentResponse(ctx iris.Context) error {
...
type TestExtHeaderFixedOtherResponseObject interface {
	VisitTestExtHeaderFixedOtherResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderFixedOther200ApplicationtestResponse) VisitTestExtHeaderFixedOtherResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	ctx.ResponseWriter().Header().Set("Content-Type", "application/test")
	if response.ContentLength != 0 {
...
type TestExtHeaderFixedSpecialJSONResponseObject interface {
	VisitTestExtHeaderFixedSpecialJSONResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderFixedSpecialJSON200ApplicationTestPlusJSONResponse) VisitTestExtHeaderFixedSpecialJSONResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	ctx.ResponseWriter().Header().Set("Content-Type", "application/test+json")
	ctx.StatusCode(200)
...
type TestExtHeaderFixedWildcardResponseObject interface {
	VisitTestExtHeaderFixedWildcardResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderFixedWildcard200ApplicationResponse) VisitTestExtHeaderFixedWildcardResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	ctx.ResponseWriter().Header().Set("Content-Type", response.ContentType)
	if response.ContentLength != 0 {
...
type TestExtHeaderMultipartResponseObject interface {
	VisitTestExtHeaderMultipartResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderMultipartdefaultMultipartResponse) VisitTestExtHeaderMultipartResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	writer := multipart.NewWriter(ctx.ResponseWriter())
	ctx.ResponseWriter().Header().Set("Content-Type", writer.FormDataContentType())
...
type TestExtHeaderMultipartRelatedResponseObject interface {
	VisitTestExtHeaderMultipartRelatedResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderMultipartRelateddefaultMultipartResponse) VisitTestExtHeaderMultipartRelatedResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	writer := multipart.NewWriter(ctx.ResponseWriter())
	ctx.ResponseWriter().Header().Set("Content-Type", mime.FormatMediaType("multipart/related", map[string]string{"boundary": writer.Boundary()}))
...
type TestExtHeaderNoContentResponseObject interface {
	VisitTestExtHeaderNoContentResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderNoContentdefaultResponse) VisitTestExtHeaderNoContentResponse(ctx iris.Context) error {
	ctx.Response().Header.Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.Response().Header.Set("header2", fmt.Sprint(response.Headers.Header2))
	ctx.StatusCode(response.StatusCode)
	return nil
...
type TestExtHeaderOtherResponseObject interface {
	VisitTestExtHeaderOtherResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderOtherdefaultApplicationtestResponse) VisitTestExtHeaderOtherResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	ctx.ResponseWriter().Header().Set("Content-Type", "application/test")
	if response.ContentLength != 0 {
...
type TestExtHeaderWildcardResponseObject interface {
	VisitTestExtHeaderWildcardResponse(ctx iris.Context) error
}
...
func (response TestExtHeaderWildcarddefaultApplicationResponse) VisitTestExtHeaderWildcardResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("header1", fmt.Sprint(response.Headers.Header1))
	ctx.ResponseWriter().Header().Set("header2", fmt.Sprint(response.Headers.Header2))
	ctx.ResponseWriter().Header().Set("Content-Type", response.ContentType)
	if response.ContentLength != 0 {
...
type TestExtMultipartResponseObject interface {
	VisitTestExtMultipartResponse(ctx iris.Context) error
}
...
func (response TestExtMultipartdefaultMultipartResponse) VisitTestExtMultipartResponse(ctx iris.Context) error {
	writer := multipart.NewWriter(ctx.ResponseWriter())
	ctx.ResponseWriter().Header().Set("Content-Type", writer.FormDataContentType())
	ctx.StatusCode(response.StatusCode)
...
type TestExtMultipartRelatedResponseObject interface {
	VisitTestExtMultipartRelatedResponse(ctx iris.Context) error
}
...
func (response TestExtMultipartRelateddefaultMultipartResponse) VisitTestExtMultipartRelatedResponse(ctx iris.Context) error {
	writer := multipart.NewWriter(ctx.ResponseWriter())
	ctx.ResponseWriter().Header().Set("Content-Type", mime.FormatMediaType("multipart/related", map[string]string{"boundary": writer.Boundary()}))
	ctx.StatusCode(response.StatusCode)
...
type TestExtNoContentResponseObject interface {
	VisitTestExtNoContentResponse(ctx iris.Context) error
}
...
func (response TestExtNoContentdefaultResponse) VisitTestExtNoContentResponse(ctx iris.Context) error {
	ctx.StatusCode(response.StatusCode)
	return nil
}
...
type TestExtOtherResponseObject interface {
	VisitTestExtOtherResponse(ctx iris.Context) error
}
...
func (response TestExtOtherdefaultApplicationtestResponse) VisitTestExtOtherResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("Content-Type", "application/test")
	if response.ContentLength != 0 {
		ctx.ResponseWriter().Header().Set("Content-Length", fmt.Sprint(response.ContentLength))
	}
...
type TestExtWildcardResponseObject interface {
	VisitTestExtWildcardResponse(ctx iris.Context) error
}
...
func (response TestExtWildcarddefaultApplicationResponse) VisitTestExtWildcardResponse(ctx iris.Context) error {
	ctx.ResponseWriter().Header().Set("Content-Type", response.ContentType)
	if response.ContentLength != 0 {
		ctx.ResponseWriter().Header().Set("Content-Length", fmt.Sprint(response.ContentLength))
	}
...
func (sh *strictHandler) TestExtFixedMultipart(ctx iris.Context) {
...
func (sh *strictHandler) TestExtFixedMultipartRelated(ctx iris.Context) {
...
func (sh *strictHandler) TestExtFixedNoContent(ctx iris.Context) {
...
func (sh *strictHandler) TestExtFixedOther(ctx iris.Context) {
...
func (sh *strictHandler) TestExtFixedSpecialJSON(ctx iris.Context) {
...
func (sh *strictHandler) TestExtFixedWildcard(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderFixedJSON(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderFixedMultipart(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderFixedMultipartRelated(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderFixedNoContent(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderFixedOther(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderFixedSpecialJSON(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderFixedWildcard(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderMultipart(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderMultipartRelated(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderNoContent(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderOther(ctx iris.Context) {
...
func (sh *strictHandler) TestExtHeaderWildcard(ctx iris.Context) {
...
func (sh *strictHandler) TestExtMultipart(ctx iris.Context) {
...
func (sh *strictHandler) TestExtMultipartRelated(ctx iris.Context) {
...
func (sh *strictHandler) TestExtNoContent(ctx iris.Context) {
...
func (sh *strictHandler) TestExtOther(ctx iris.Context) {
...
func (sh *strictHandler) TestExtWildcard(ctx iris.Context) {
