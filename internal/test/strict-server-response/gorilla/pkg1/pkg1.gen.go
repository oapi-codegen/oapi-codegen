...
func HandlerWithOptions(si ServerInterface, options GorillaServerOptions) http.Handler {
	...
	r.HandleFunc(options.BaseURL+"/test-ext-fixed-multipart", wrapper.TestExtFixedMultipart).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-fixed-multipart-related", wrapper.TestExtFixedMultipartRelated).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-fixed-nocontent", wrapper.TestExtFixedNoContent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-fixed-other", wrapper.TestExtFixedOther).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-fixed-special-json", wrapper.TestExtFixedSpecialJSON).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-fixed-wildcard", wrapper.TestExtFixedWildcard).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-fixed-json", wrapper.TestExtHeaderFixedJSON).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-fixed-multipart", wrapper.TestExtHeaderFixedMultipart).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-fixed-multipart-related", wrapper.TestExtHeaderFixedMultipartRelated).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-fixed-nocontent", wrapper.TestExtHeaderFixedNoContent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-fixed-other", wrapper.TestExtHeaderFixedOther).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-fixed-special-json", wrapper.TestExtHeaderFixedSpecialJSON).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-fixed-wildcard", wrapper.TestExtHeaderFixedWildcard).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-multipart", wrapper.TestExtHeaderMultipart).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-multipart-related", wrapper.TestExtHeaderMultipartRelated).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-nocontent", wrapper.TestExtHeaderNoContent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-other", wrapper.TestExtHeaderOther).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-header-wildcard", wrapper.TestExtHeaderWildcard).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-multipart", wrapper.TestExtMultipart).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-multipart-related", wrapper.TestExtMultipartRelated).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-nocontent", wrapper.TestExtNoContent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-other", wrapper.TestExtOther).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ext-wildcard", wrapper.TestExtWildcard).Methods("GET")
