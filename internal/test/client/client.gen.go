...
func BindPostBothJSONRequestBody(ctx echo.Context) (PostBothJSONRequestBody, error) {
	var body PostBothJSONRequestBody
...
// HACK: add convenience function to unmarshal json body
func BindPostJsonJSONRequestBody(ctx echo.Context) (PostJsonJSONRequestBody, error) {
	var body PostJsonJSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return body, err
	}
	return body, nil
