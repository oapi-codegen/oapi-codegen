...
// Package eventscallbacks provides primitives to interact with the openapi HTTP API.
//
...
type ClientInterface interface {
	...
	// PlantTreeWithBody Request a tree planting (async; result delivered via callback).
	//
	...
	// PlantTree Request a tree planting (async; result delivered via callback).
	//
...
type ClientWithResponsesInterface interface {
	...
	// PlantTreeWithBodyWithResponse Request a tree planting (async; result delivered via callback).
	//
	...
	// PlantTreeWithResponse Request a tree planting (async; result delivered via callback).
	//
