...
// webhook fiber.Handler returned by {Op}WebhookHandler at
...
type WebhookReceiverInterface interface {
	...
	HandlePetStatusChangedWebhook(c *fiber.Ctx) error
}

// PetStatusChangedWebhookHandler returns the fiber.Handler for the petStatusChanged webhook.
...
func PetStatusChangedWebhookHandler(si WebhookReceiverInterface) fiber.Handler {
	return func(c *fiber.Ctx) error {
		return si.HandlePetStatusChangedWebhook(c)
	}
}
