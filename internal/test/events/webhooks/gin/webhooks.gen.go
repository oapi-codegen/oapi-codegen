...
type WebhookReceiverInterface interface {
	...
	HandlePetStatusChangedWebhook(c *gin.Context)
}

// PetStatusChangedWebhookHandler returns the gin.HandlerFunc for the petStatusChanged webhook.
...
func PetStatusChangedWebhookHandler(si WebhookReceiverInterface) gin.HandlerFunc {
	return func(c *gin.Context) {
		si.HandlePetStatusChangedWebhook(c)
	}
}
