...
type ClientInterface interface {
	...
	// Issue185WithBody performs a GET /issues/185 (the `Issue185` operationId) request, with any type of body, and a specified content type
	...
	// GetIssues375 performs a GET /issues/375 (the `` operationId) request
	...
	// Issue9WithBody performs a GET /issues/9 (the `Issue9` operationId) request, with any type of body, and a specified content type
...
type ClientWithResponsesInterface interface {
	...
	// EnsureEverythingIsReferenced performs a GET /ensure-everything-is-referenced (the `ensureEverythingIsReferenced` operationId) request, and returns a wrapper object for the known response body format(s).
	...
	// Issue1051 performs a GET /issues/1051 (the `Issue1051` operationId) request, and returns a wrapper object for the known response body format(s).
	Issue1051WithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*Issue1051Response, error)

	// Issue127 performs a GET /issues/127 (the `Issue127` operationId) request, and returns a wrapper object for the known response body format(s).
	Issue127WithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*Issue127Response, error)

	// Issue185WithBody performs a GET /issues/185 (the `Issue185` operationId) request, with any type of body, and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// Issue209 performs a GET /issues/209/${str} (the `Issue209` operationId) request, and returns a wrapper object for the known response body format(s).
	Issue209WithResponse(ctx context.Context, str StringInPath, reqEditors ...RequestEditorFn) (*Issue209Response, error)

	// Issue30 performs a GET /issues/30/{fallthrough} (the `Issue30` operationId) request, and returns a wrapper object for the known response body format(s).
	Issue30WithResponse(ctx context.Context, pFallthrough string, reqEditors ...RequestEditorFn) (*Issue30Response, error)

	// GetIssues375 performs a GET /issues/375 (the `` operationId) request, and returns a wrapper object for the known response body format(s).
	GetIssues375WithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetIssues375Response, error)

	// Issue41 performs a GET /issues/41/{1param} (the `Issue41` operationId) request, and returns a wrapper object for the known response body format(s).
	Issue41WithResponse(ctx context.Context, n1param N5StartsWithNumber, reqEditors ...RequestEditorFn) (*Issue41Response, error)

	// Issue9WithBody performs a GET /issues/9 (the `Issue9` operationId) request, with any type of body, and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// Issue975 performs a GET /issues/975 (the `Issue975` operationId) request, and returns a wrapper object for the known response body format(s).
