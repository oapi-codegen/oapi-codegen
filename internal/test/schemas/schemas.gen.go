...
func BindIssue185JSONRequestBody(ctx echo.Context) (Issue185JSONRequestBody, error) {
	var body Issue185JSONRequestBody
...
// HACK: add convenience function to unmarshal json body
func BindIssue9JSONRequestBody(ctx echo.Context) (Issue9JSONRequestBody, error) {
	var body Issue9JSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return body, err
	}
	return body, nil
