...
// issue #2367: code generated from a spec whose global security block names
// a scheme absent from components/securitySchemes must compile and the
// ServerInterface must be satisfiable.
