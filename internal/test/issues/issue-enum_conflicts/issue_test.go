...
func TestEnumConflicts(t *testing.T) {
	...
	require.Equal(t, `"Fruit"`, constDefs["FoodGroupsFruit"])
	require.Equal(t, `"Vegetables"`, constDefs["FoodGroupsVegetables"])
	require.Equal(t, `"Apple"`, constDefs["FruitApple"])
	require.Equal(t, `"Bananas"`, constDefs["FruitBananas"])
	require.Equal(t, `"Orange"`, constDefs["FruitOrange"])
	require.Equal(t, `"Carrots"`, constDefs["Carrots"])
	require.Equal(t, `"Potatoes"`, constDefs["Potatoes"])
