...
type ClientInterface interface {
	...
	// TestWithBody performs a GET /test (the `test` operationId) request, with any type of body, and a specified content type
	...
	// with the `application/test+json` content type.
...
type ClientWithResponsesInterface interface {
	...
	// TestWithBody performs a GET /test (the `test` operationId) request, with any type of body, and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// TestWithApplicationTestPlusJSONBody performs a GET /test (the `test` operationId) request,
	// with the `application/test+json` content type, and returns a wrapper object for the known response body format(s).
