// Package issue1381 provides primitives to interact with the openapi HTTP API.
//
...
// TestMultipartBody defines parameters for Test.
type TestMultipartBody struct {
	BinaryData *openapi_types.File `json:"binaryData,omitempty"`
	JsonData   *Test               `json:"jsonData,omitempty"`
}

// TestMultipartRequestBody defines body for Test for multipart/related ContentType.
type TestMultipartRequestBody TestMultipartBody
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.POST(options.BaseURL+"/test", wrapper.Test)
}
