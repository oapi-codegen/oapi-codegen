...
// PostInvalidExtRefTrouble300 defines model for POST /invalidExtRefTrouble (application/json).
type PostInvalidExtRefTrouble300 externalRef0.Pascal

// PostNoTrouble200 defines model for POST /noTrouble (application/json).
