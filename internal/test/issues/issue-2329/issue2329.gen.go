...
type ClientInterface interface {
	...
	// CreateThingWithBody performs a POST /things (the `createThing` operationId) request, with any type of body, and a specified content type
...
type ClientWithResponsesInterface interface {
	...
	// CreateThingWithBody performs a POST /things (the `createThing` operationId) request, with any type of body, and a specified content type, and returns a wrapper object for the known response body format(s).
