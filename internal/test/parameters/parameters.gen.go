...
func (w *ServerInterfaceWrapper) EnumParams(ctx echo.Context) error {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "enumPathParam", ctx.QueryParams(), &params.EnumPathParam)
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetDeepObject(ctx echo.Context) error {
	...
	err = runtime.BindQueryParameter("deepObject", true, true, nil, "deepObj", ctx.QueryParams(), &params.DeepObj)
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetQueryForm(ctx echo.Context) error {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "ea", ctx.QueryParams(), &params.Ea)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ea: %s", err))
	}
	...
	err = runtime.BindQueryParameter("form", false, false, nil, "a", ctx.QueryParams(), &params.A)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter a: %s", err))
	}
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "eo", ctx.QueryParams(), &params.Eo)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter eo: %s", err))
	}
	...
	err = runtime.BindQueryParameter("form", false, false, nil, "o", ctx.QueryParams(), &params.O)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter o: %s", err))
	}
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "ep", ctx.QueryParams(), &params.Ep)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ep: %s", err))
	}
	...
	err = runtime.BindQueryParameter("form", false, false, nil, "p", ctx.QueryParams(), &params.P)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter p: %s", err))
	}
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "ps", ctx.QueryParams(), &params.Ps)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "1s", ctx.QueryParams(), &params.N1s)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter 1s: %s", err))
	}
