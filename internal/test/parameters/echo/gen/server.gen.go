...
func (w *ServerInterfaceWrapper) GetCookie(ctx echo.Context) error {
	...
	if cookie, err := ctx.Cookie("ep"); err == nil {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ep: '%s'", cookie.Value)).SetInternal(err)
		}
		params.Ep = &value
	...
	if cookie, err := ctx.Cookie("ea"); err == nil {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ea: '%s'", cookie.Value)).SetInternal(err)
		}
		params.Ea = &value
	...
	if cookie, err := ctx.Cookie("a"); err == nil {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter a: '%s'", cookie.Value)).SetInternal(err)
		}
		params.A = &value
	...
	if cookie, err := ctx.Cookie("eo"); err == nil {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter eo: '%s'", cookie.Value)).SetInternal(err)
		}
		params.Eo = &value
	...
	if cookie, err := ctx.Cookie("o"); err == nil {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter o: '%s'", cookie.Value)).SetInternal(err)
		}
		params.O = &value
	...
	if cookie, err := ctx.Cookie("1s"); err == nil {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter 1s: '%s'", cookie.Value)).SetInternal(err)
		}
		params.N1s = &value
...
func (w *ServerInterfaceWrapper) EnumParams(ctx echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter enumPathParam: '%s'", ctx.QueryParams().Get("enumPathParam"))).SetInternal(err)
	}
...
func (w *ServerInterfaceWrapper) GetHeader(ctx echo.Context) error {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Primitive")]; found {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter X-Primitive: '%s'", valueList[0])).SetInternal(err)
		}
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Primitive-Exploded")]; found {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter X-Primitive-Exploded: '%s'", valueList[0])).SetInternal(err)
		}
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Array-Exploded")]; found {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter X-Array-Exploded: '%s'", valueList[0])).SetInternal(err)
		}
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Array")]; found {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter X-Array: '%s'", valueList[0])).SetInternal(err)
		}
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Object-Exploded")]; found {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter X-Object-Exploded: '%s'", valueList[0])).SetInternal(err)
		}
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Object")]; found {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter X-Object: '%s'", valueList[0])).SetInternal(err)
		}
	...
	if valueList, found := headers[http.CanonicalHeaderKey("1-Starting-With-Number")]; found {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter 1-Starting-With-Number: '%s'", valueList[0])).SetInternal(err)
		}
...
func (w *ServerInterfaceWrapper) GetLabelExplodeArray(ctx echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter param: '%s'", ctx.Param("param"))).SetInternal(err)
	}
...
func (w *ServerInterfaceWrapper) GetMatrixExplodeArray(ctx echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter id: '%s'", ctx.Param("id"))).SetInternal(err)
	}
...
func (w *ServerInterfaceWrapper) GetDeepObject(ctx echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter deepObj: '%s'", ctx.QueryParams().Get("deepObj"))).SetInternal(err)
	}
...
func (w *ServerInterfaceWrapper) GetQueryDelimited(ctx echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter sa: '%s'", ctx.QueryParams().Get("sa"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter pa: '%s'", ctx.QueryParams().Get("pa"))).SetInternal(err)
	}
...
func (w *ServerInterfaceWrapper) GetQueryForm(ctx echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ea: '%s'", ctx.QueryParams().Get("ea"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter a: '%s'", ctx.QueryParams().Get("a"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter eo: '%s'", ctx.QueryParams().Get("eo"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter o: '%s'", ctx.QueryParams().Get("o"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ep: '%s'", ctx.QueryParams().Get("ep"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter p: '%s'", ctx.QueryParams().Get("p"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ps: '%s'", ctx.QueryParams().Get("ps"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter 1s: '%s'", ctx.QueryParams().Get("1s"))).SetInternal(err)
	}
