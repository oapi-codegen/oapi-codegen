...
func RegisterHandlerVersionsWithOptions(
	...
	// /simpleString/{param}
	versionedPath = "/" + version + "/simpleString/:param"
	if apiHandlers[versionedPath] == nil {
		apiHandlers[versionedPath] = make(map[string]fiber.Handler)
	}

	latestPath = "/" + fibermid.LatestVersion + "/simpleString/:param"
	if apiHandlers[latestPath] == nil {
		apiHandlers[latestPath] = make(map[string]fiber.Handler)
	}

	apiHandlers[versionedPath]["GET"] = wrapper.GetSimpleString
	apiHandlers[latestPath]["GET"] = wrapper.GetSimpleString
