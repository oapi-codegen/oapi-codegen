...
// outputoptions/response-body-getters/enabled: when skip-response-body-getters is unset
// (default), the generated response type must expose GetBody() and a typed getter for
// each response field.
