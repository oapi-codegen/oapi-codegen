...
func (siw *ServerInterfaceWrapper) GetThing(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "id", chi.URLParam(r, "id"), &id, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (response GetThing200JSONResponse) VisitGetThingResponse(w http.ResponseWriter) error {
	...
	if response.Headers.ETag != nil {
		{
			v, err := runtime.StyleParamWithOptions("simple", false, "ETag", *response.Headers.ETag, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationHeader, Type: "string", Format: ""})
			if err != nil {
				return fmt.Errorf("error styling response header ETag: %w", err)
			}
			w.Header().Set("ETag", v)
		}
	}
