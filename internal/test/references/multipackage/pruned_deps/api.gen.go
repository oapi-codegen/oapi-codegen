// Package prunedeps provides primitives to interact with the openapi HTTP API.
//
...
import (
	...
	externalRef0 "github.com/wayleadr/oapi-codegen/v2/internal/test/references/multipackage/pruned_deps/deps"
)
