// Package externaljsonref provides primitives to interact with the openapi HTTP API.
//
...
import (
	...
	externalRef0 "github.com/wayleadr/oapi-codegen/v2/internal/test/references/overlays/external_json_ref/packageA"
)
