...
// issue #2232: TestExtraTagsOnQueryParams verifies that x-oapi-codegen-extra-tags
// is applied to query parameter struct fields regardless of whether the extension
// is placed at the parameter level or at the schema level within the parameter.
