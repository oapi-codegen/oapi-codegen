...
type ServerInterface interface {
	...
	UnionInRefExample(w http.ResponseWriter, r *http.Request)
}
...
// (POST /with-union-in-ref)
func (_ Unimplemented) UnionInRefExample(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) UnionInRefExample(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UnionInRefExample(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/with-union-in-ref", wrapper.UnionInRefExample)
	})
...
// UnionInRefExample operation middleware
func (sh *strictHandler) UnionInRefExample(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		if err := validResponse.VisitUnionInRefExampleResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
