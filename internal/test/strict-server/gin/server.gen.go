...
type ServerInterface interface {
	...
	// (GET /streaming)
	StreamingExample(c *gin.Context)
...
func (siw *ServerInterfaceWrapper) StreamingExample(c *gin.Context) {
	...
	siw.Handler.StreamingExample(c)
}
...
// StreamingExample operation middleware
func (sh *strictHandler) StreamingExample(ctx *gin.Context) {
	...
	if err != nil {
		...
		if err := validResponse.VisitStreamingExampleResponse(ctx.Writer); err != nil {
			ctx.Error(err)
		}
	} else if response != nil {
		ctx.Error(fmt.Errorf("unexpected response type: %T", response))
