...
type ServerInterface interface {
	...
	UnionInRefExample(c *fiber.Ctx) error
}
...
func (siw *ServerInterfaceWrapper) UnionInRefExample(c *fiber.Ctx) error {

	return siw.Handler.UnionInRefExample(c)
}
...
type UnionInRefExampleResponseObject interface {
	VisitUnionInRefExampleResponse(ctx *fiber.Ctx) error
}

type UnionInRefExample200JSONResponse OneOfExample

func (response UnionInRefExample200JSONResponse) VisitUnionInRefExampleResponse(ctx *fiber.Ctx) error {
	ctx.Response().Header.Set("Content-Type", "application/json")
	ctx.Status(200)
...
// UnionInRefExample operation middleware
func (sh *strictHandler) UnionInRefExample(ctx *fiber.Ctx) error {
	...
	handler := func(ctx *fiber.Ctx, request interface{}) (interface{}, error) {
		return sh.ssi.UnionInRefExample(ctx.UserContext(), request.(UnionInRefExampleRequestObject))
	}
	for _, middleware := range sh.middlewares {
