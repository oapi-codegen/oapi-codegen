...
func (siw *ServerInterfaceWrapper) HeadersExample(c *fiber.Ctx) error {
	...
	if values, found := headers[http.CanonicalHeaderKey("header1")]; found {
		var Header1 string

		err = runtime.BindStyledParameterWithOptions("simple", "header1", strings.Join(values, ","), &Header1, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: true})
		if err != nil {
	...
	if values, found := headers[http.CanonicalHeaderKey("header2")]; found {
		var Header2 int

		err = runtime.BindStyledParameterWithOptions("simple", "header2", strings.Join(values, ","), &Header2, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false})
		if err != nil {
