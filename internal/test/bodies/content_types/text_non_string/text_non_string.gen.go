...
// Package textnonstring provides primitives to interact with the openapi HTTP API.
//
...
func (response GetPing202TextResponse) VisitGetPingResponse(w http.ResponseWriter) error {
