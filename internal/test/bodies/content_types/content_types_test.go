// issue #1914: a text/plain request body whose schema is a scalar must coerce
// the Go value to its string form. The generated client helpers
// NewPostPetRequestWithTextBody / NewPostPet1234RequestWithTextBody are
// synthesized from the operationId-less /pet and /pet/1234 POST operations.
