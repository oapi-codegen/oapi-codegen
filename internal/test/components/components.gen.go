...
func BindEnsureEverythingIsReferencedJSONRequestBody(ctx echo.Context) (EnsureEverythingIsReferencedJSONRequestBody, error) {
	var body EnsureEverythingIsReferencedJSONRequestBody
...
// HACK: add convenience function to unmarshal json body
func BindBodyWithAddPropsJSONRequestBody(ctx echo.Context) (BodyWithAddPropsJSONRequestBody, error) {
	var body BodyWithAddPropsJSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return body, err
	}
	return body, nil
