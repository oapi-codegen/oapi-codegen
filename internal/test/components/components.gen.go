...
// EnsureEverythingIsReferenced200 defines model for GET /ensure-everything-is-referenced (application/json).
...
// EnsureEverythingIsReferenceddefaultJSON defines model for GET /ensure-everything-is-referenced (application/json).
type EnsureEverythingIsReferenceddefaultJSON RenamedResponseObject

// EnsureEverythingIsReferenceddefaultTextplain defines model for GET /ensure-everything-is-referenced (text/plain).
type EnsureEverythingIsReferenceddefaultTextplain RenamedResponseObject

// ParamsWithAddPropsdefault defines model for GET /params_with_add_props (text/plain).
type ParamsWithAddPropsdefault = string

// BodyWithAddPropsdefault defines model for POST /params_with_add_props (text/plain).
