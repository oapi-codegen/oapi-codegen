// Package colonpathsecho provides primitives to interact with the openapi HTTP API.
//
...
func RegisterHandlersWithOptions(router EchoRouter, si ServerInterface, options RegisterHandlersOptions) {
	...
	router.POST(options.BaseURL+"/pets\\:generate", wrapper.GeneratePets, options.OperationMiddlewares["generatePets"]...)
