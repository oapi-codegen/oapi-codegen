...
func (w *ServerInterfaceWrapper) GetPet(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "petId", ctx.Param("petId"), &petId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: ctx.Request().URL.RawPath == ""})
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetSimplePrimitive(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "param", ctx.Param("param"), &param, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "int32", Types: []string{}, ValueIsUnescaped: ctx.Request().URL.RawPath == ""})
	if err != nil {
