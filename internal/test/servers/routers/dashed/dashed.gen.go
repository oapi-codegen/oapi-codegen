...
// Package serversroutersdashed provides primitives to interact with the openapi HTTP API.
//
...
func (siw *ServerInterfaceWrapper) GetResource(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "addressing-identifier", r.PathValue("addressing_identifier"), &addressingIdentifier, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: true})
	if err != nil {
