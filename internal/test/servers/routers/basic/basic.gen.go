// Package serversroutersbasic provides primitives to interact with the openapi HTTP API.
//
...
func (siw *ServerInterfaceWrapper) GetWithArgs(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "optional_argument", r.URL.Query(), &params.OptionalArgument, runtime.BindQueryParameterOptions{Type: "integer", Format: "int64", Types: []string{}})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, true, "required_argument", r.URL.Query(), &params.RequiredArgument, runtime.BindQueryParameterOptions{Type: "integer", Format: "int64", Types: []string{}})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("header_argument")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "header_argument", valueList[0], &HeaderArgument, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "integer", Format: "int32", Types: []string{}})
		if err != nil {
...
func (siw *ServerInterfaceWrapper) GetWithReferences(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "global_argument", chi.URLParam(r, "global_argument"), &globalArgument, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "int64", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "argument", chi.URLParam(r, "argument"), &argument, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetWithContentType(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "content_type", chi.URLParam(r, "content_type"), &contentType, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) CreateResource2(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "inline_argument", chi.URLParam(r, "inline_argument"), &inlineArgument, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "inline_query_argument", r.URL.Query(), &params.InlineQueryArgument, runtime.BindQueryParameterOptions{Type: "integer", Format: "", Types: []string{}})
	if err != nil {
		var requiredError *runtime.RequiredParameterError
		if errors.As(err, &requiredError) {
...
func (siw *ServerInterfaceWrapper) UpdateResource3(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "fallthrough", chi.URLParam(r, "fallthrough"), &pFallthrough, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
