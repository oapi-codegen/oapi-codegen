...
type ServerInterface interface {
	...
	SameNameParamAndBodyProperty(w http.ResponseWriter, r *http.Request, name string)
...
// (POST /same-name-param-and-body-property/{name})
func (_ Unimplemented) SameNameParamAndBodyProperty(w http.ResponseWriter, r *http.Request, name string) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) ReservedGoKeywordParameters(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "type", chi.URLParam(r, "type"), &pType, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) SameNameParamAndBodyProperty(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "name", chi.URLParam(r, "name"), &name, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SameNameParamAndBodyProperty(w, r, name)
	}))
...
// SameNameParamAndBodyProperty operation middleware
func (sh *strictHandler) SameNameParamAndBodyProperty(w http.ResponseWriter, r *http.Request, name string) {
	...
	if err != nil {
		...
		if err := validResponse.VisitSameNameParamAndBodyPropertyResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
