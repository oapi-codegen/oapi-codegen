...
func RegisterHandlerVersionsWithOptions(
	...
	// /same-name-param-and-body-property/{name}
	versionedPath = "/" + version + "/same-name-param-and-body-property/:name"
	if apiHandlers[versionedPath] == nil {
		apiHandlers[versionedPath] = make(map[string]fiber.Handler)
	}

	latestPath = "/" + fibermid.LatestVersion + "/same-name-param-and-body-property/:name"
	if apiHandlers[latestPath] == nil {
		apiHandlers[latestPath] = make(map[string]fiber.Handler)
	}

	apiHandlers[versionedPath]["POST"] = wrapper.SameNameParamAndBodyProperty
	apiHandlers[latestPath]["POST"] = wrapper.SameNameParamAndBodyProperty
