...
func (siw *ServerInterfaceWrapper) ReservedGoKeywordParameters(c fiber.Ctx) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "type", c.Params("type"), &pType, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) SameNameParamAndBodyProperty(c fiber.Ctx) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "name", c.Params("name"), &name, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}})
	if err != nil {
