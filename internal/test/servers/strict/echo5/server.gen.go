...
func (w *ServerInterfaceWrapper) ReservedGoKeywordParameters(ctx *echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "type", ctx.Param("type"), &pType, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: ctx.Request().URL.RawPath == ""})
	if err != nil {
...
func (w *ServerInterfaceWrapper) SameNameParamAndBodyProperty(ctx *echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "name", ctx.Param("name"), &name, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", Types: []string{}, ValueIsUnescaped: ctx.Request().URL.RawPath == ""})
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter name: %s", err))
	}

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.SameNameParamAndBodyProperty(ctx, name)
	return err
}
...
func (sh *strictHandler) SameNameParamAndBodyProperty(ctx *echo.Context, name string) error {
	...
	if err != nil {
		...
		return validResponse.VisitSameNameParamAndBodyPropertyResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
