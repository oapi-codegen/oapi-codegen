...
func (siw *ServerInterfaceWrapper) GetWithArgs(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "optional_argument", r.URL.Query(), &params.OptionalArgument)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, true, nil, "required_argument", r.URL.Query(), &params.RequiredArgument)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) CreateResource2(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "inline_query_argument", r.URL.Query(), &params.InlineQueryArgument)
	if err != nil {
