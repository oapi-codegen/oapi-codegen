...
func BindCreateResourceJSONRequestBody(ctx echo.Context) (CreateResourceJSONRequestBody, error) {
...
// HACK: add convenience function to unmarshal json body
func BindCreateResource2JSONRequestBody(ctx echo.Context) (CreateResource2JSONRequestBody, error) {
...
// HACK: add convenience function to unmarshal json body
func BindUpdateResource3JSONRequestBody(ctx echo.Context) (UpdateResource3JSONRequestBody, error) {
