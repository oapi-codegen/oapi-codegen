...
```go
//go:generate go run github.com/oapi-codegen/oapi-codegen/cmd/oapi-codegen --config=config.yaml ../../api.yaml
```
...
$ go get github.com/oapi-codegen/oapi-codegen@master
# alternatively, to a commit hash i.e. https://github.com/deepmap/oapi-codegen/commit/71e916c59688a6379b5774dfe5904ec222b9a537
$ go get github.com/oapi-codegen/oapi-codegen@71e916c59688a6379b5774dfe5904ec222b9a537
```
...
+++ go.mod
@@ -2,21 +2,20 @@
-require github.com/oapi-codegen/oapi-codegen v2.1.0
+require github.com/oapi-codegen/oapi-codegen v2.1.1-0.20240331212514-80f0b978ef16
```
...
For full details of what is supported, it's worth checking out [the GoDoc for `codegen.Configuration`](https://pkg.go.dev/github.com/oapi-codegen/oapi-codegen/pkg/codegen#Configuration).
...
In this case, we will expose a [compatibility option](https://pkg.go.dev/github.com/oapi-codegen/oapi-codegen/pkg/codegen#CompatibilityOptions) to restore old behaviour.
...
import (
	...
	"github.com/oapi-codegen/oapi-codegen/examples/minimal-server/stdhttp/api"
)
...
import (
	...
	"github.com/oapi-codegen/oapi-codegen/examples/minimal-server/gorillamux/api"
...
import (
	...
	"github.com/oapi-codegen/oapi-codegen/examples/minimal-server/echo/api"
	"github.com/labstack/echo/v4"
)
...
import (
	...
	"github.com/oapi-codegen/oapi-codegen/examples/minimal-server/fiber/api"
	"github.com/gofiber/fiber/v2"
)
...
import (
	...
	"github.com/oapi-codegen/oapi-codegen/examples/minimal-server/gin/api"
	"github.com/gin-gonic/gin"
)
...
//go:generate go run github.com/oapi-codegen/oapi-codegen/cmd/oapi-codegen -config cfg.yaml api.yaml
```
...
import (
	...
	"github.com/oapi-codegen/oapi-codegen/examples/client"
)
...
import-mapping:
  ...
  ../common/api.yaml: github.com/oapi-codegen/oapi-codegen/examples/import-mapping/common
```
...
import (
	// ...
	externalRef0 "github.com/oapi-codegen/oapi-codegen/examples/import-mapping/common"
)
...
import (
	...
	"github.com/oapi-codegen/oapi-codegen/pkg/securityprovider"
)
...
Notice that we're using a pre-built provider from the [`pkg/securityprovider` package](https://pkg.go.dev/github.com/oapi-codegen/oapi-codegen/pkg/securityprovider), which has some inbuilt support for other types of authentication, too.
...
Check [the docs](https://pkg.go.dev/github.com/oapi-codegen/oapi-codegen/pkg/codegen#OutputOptions) for more details of usage.
