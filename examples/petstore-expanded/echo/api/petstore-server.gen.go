...
func (w *ServerInterfaceWrapper) FindPets(ctx echo.Context) error {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "tags", ctx.QueryParams(), &params.Tags)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "limit", ctx.QueryParams(), &params.Limit)
	if err != nil {
