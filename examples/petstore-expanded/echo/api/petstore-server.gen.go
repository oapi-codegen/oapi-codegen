...
func (w *ServerInterfaceWrapper) FindPets(ctx echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter tags: '%s'", ctx.QueryParams().Get("tags"))).SetInternal(err)
	}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter limit: '%s'", ctx.QueryParams().Get("limit"))).SetInternal(err)
	}
