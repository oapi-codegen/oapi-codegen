...
import (
	...
	"github.com/wayleadr/oapi-codegen/v2/examples/petstore-expanded/stdhttp/api"
)
...
func (p *PetStore) FindPets(w http.ResponseWriter, r *http.Request, params api.FindPetsParams) {
