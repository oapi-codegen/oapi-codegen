...
func (siw *ServerInterfaceWrapper) FindPets(c *gin.Context) {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "tags", c.Request.URL.Query(), &params.Tags)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "limit", c.Request.URL.Query(), &params.Limit)
	if err != nil {
