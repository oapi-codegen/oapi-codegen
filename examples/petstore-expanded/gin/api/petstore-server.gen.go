...
func (siw *ServerInterfaceWrapper) FindPets(c *gin.Context) {
	...
	if err != nil {
		siw.ErrorHandler(c, &InvalidParamFormatError{ParamName: "tags", Err: err}, http.StatusBadRequest)
		return
	}
	...
	if err != nil {
		siw.ErrorHandler(c, &InvalidParamFormatError{ParamName: "limit", Err: err}, http.StatusBadRequest)
		return
	}
...
func (siw *ServerInterfaceWrapper) DeletePet(c *gin.Context) {
	...
	if err != nil {
		siw.ErrorHandler(c, &InvalidParamFormatError{ParamName: "id", Err: err}, http.StatusBadRequest)
		return
	}
