...
func (w *ServerInterfaceWrapper) FindPets(ctx iris.Context) {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "tags", ctx.Request().URL.Query(), &params.Tags)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, nil, "limit", ctx.Request().URL.Query(), &params.Limit)
	if err != nil {
		ctx.StatusCode(http.StatusBadRequest)
