...
func (w *ServerInterfaceWrapper) FindPets(ctx *fiber.Ctx) error {
	...
	err = runtime.BindQueryParameter("form", true, false, "tags", u.Query(), &params.Tags)
	if err != nil {
	...
	err = runtime.BindQueryParameter("form", true, false, "limit", u.Query(), &params.Limit)
	if err != nil {
...
func GetSwagger() (swagger *openapi3.T, err error) {
	...
	loader.ReadFromURIFunc = func(_ *openapi3.Loader, url *url.URL) ([]byte, error) {
