...
replace github.com/deepmap/oapi-codegen/pkg/middleware => ../pkg/middleware

replace github.com/deepmap/oapi-codegen/pkg/chi-middleware => ../pkg/chi-middleware

replace github.com/deepmap/oapi-codegen/pkg/fiber-middleware => ../pkg/fiber-middleware
