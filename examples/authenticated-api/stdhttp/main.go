...
import (
	...
	"github.com/wayleadr/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/wayleadr/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
