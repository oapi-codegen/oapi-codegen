...
// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.Get
func (r *RequestBuilder) Get(path string) *RequestBuilder {
	return r.WithMethod("GET", path)
}

// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.Post
func (r *RequestBuilder) Post(path string) *RequestBuilder {
	return r.WithMethod("POST", path)
}

// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.Put
func (r *RequestBuilder) Put(path string) *RequestBuilder {
	return r.WithMethod("PUT", path)
}

// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.Patch
func (r *RequestBuilder) Patch(path string) *RequestBuilder {
	return r.WithMethod("PATCH", path)
}

// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.Delete
...
// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.WithContentType
func (r *RequestBuilder) WithContentType(value string) *RequestBuilder {
	return r.WithHeader("Content-Type", value)
}

// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.WithJsonContentType
...
// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.WithAcceptJson
...
// Deprecated: This has been replaced by https://pkg.go.dev/github.com/oapi-codegen/testutil#RequestBuilder.WithBody
