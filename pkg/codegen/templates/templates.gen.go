...
type {{$opid | ucFirst}}HTTPResponse struct {
    Body         []byte
...
func (r {{$opid | ucFirst}}HTTPResponse) Status() string {
...
func (r {{$opid | ucFirst}}HTTPResponse) StatusCode() int {
    if r.HTTPResponse != nil {
...
// {{$opid}}{{if .HasBody}}WithBody{{end}}WithResponse request{{if .HasBody}} with arbitrary body{{end}} returning *{{$opid}}HTTPResponse
...
//
// Code generated by github.com/dmhdeveloper/oapi-codegen DO NOT EDIT.
package {{.PackageName}}
...
import (
	...
	"github.com/dmhdeveloper/oapi-codegen/pkg/runtime"
	openapi_types "github.com/dmhdeveloper/oapi-codegen/pkg/types"
