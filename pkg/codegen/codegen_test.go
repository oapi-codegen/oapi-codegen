...
const (
	...
	remoteRefImport = `github.com/ula/oapi-codegen/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/ula/oapi-codegen/examples/petstore-expanded"`)
