...
import (
	...
	examplePetstoreClient "github.com/do87/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/do87/oapi-codegen/examples/petstore-expanded/echo/api"
...
const (
	...
	remoteRefImport = `github.com/do87/oapi-codegen/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/do87/oapi-codegen/examples/petstore-expanded"`)
